...
namespace MetaModels\AttributeTranslatedUrlBundle\DependencyInjection;
 ...
 */
class MetaModelsAttributeTranslatedUrlExtension extends Extension
{
    /**
     * {@inheritDoc}
     */
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $managedSchemaTypeNames[] = 'translatedurl';
